...
//         props: {
//             app_id:
//                 (context.query.app_id?.toString() as `app_${string}`) || 'app_staging_627c1f36530d1f0fac88c5bb1618bbfe',
...
// const Index = ({ app_id, action, signal }: InferGetServerSidePropsType<typeof getServerSideProps>) => (
//     <IDKitWidget
//         action={action}
//         signal={signal}
